...
<body>
<div class="container">
  <h1 align="center"> QUẢN LÝ SÁCH</h1>
  ...
  <a class="btn btn-dark" href="book?action=create" role="button">Thêm mới sách</a>
</div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <%--Modal--%>
      <form action="/book" id="deleteForm" method="post">
        <div class="modal-body">
          <input type="hidden" name="action" value="delete"/>
          <input type="hidden" id="id" name="id"/>
          <span>Bạn có muốn xóa sách <b><span id="nameDelete"></span></b> không ?</span>
        </div>
